...
export function MailIcon({ className, ...props }: React.SVGProps<SVGSVGElement>) {
    return (
        <svg
            ...
            {...props}
        >
            <path d="M24 5.457v13.086c0 .804-.652 1.457-1.457 1.457H1.457C.652 20 0 19.347 0 18.543V5.457C0 4.653.652 4 1.457 4h21.086c.805 0 1.457.653 1.457 1.457zM22.25 6.5L12 12.25 1.75 6.5v11.75h20.5V6.5zM3.5 7.5l8.5 4.75 8.5-4.75v1.25L12 13.5 3.5 8.75V7.5z" />
        </svg>
    );
}

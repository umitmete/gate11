...
export const translations = {
    de: {
        ...
        hero: {
            title: 'GATE',
            subtitle: 'Exklusive Fahrzeuge. Erstklassige Ausbildung.',
            description: 'Für deine Ausbildung stehen dir die neuesten Modelle von Volkswagen, BMW und Kawasaki zur Verfügung. Erlebe moderne Systeme ab Tag eins.',
        ...
        about: {
            ...
            phil_h2: 'Fahren ist für uns mehr als ein Handwerk – wir machen daraus echte Meisterschaft.',
            phil_p1: 'Seit 2019 verfolgt GATE11 die Vision, Fahrausbildung zu einem Erlebnis von Qualität und Stil zu machen. Jeder Schüler wird individuell gefördert.',
            phil_p2: 'Unsere Mentoren vermitteln ein tiefes Verständnis für Fahrzeug, Straße und sicheres Fahren.',
            ...
            team_p1: 'Unser handverlesenes Expertenteam teilt die Leidenschaft für erstklassigen Service.',
            team_p2: 'Vertrauen bildet die Grundlage jeder sicheren Fahrt – und wir freuen uns darauf, Sie auf Ihrem Weg zu begleiten.',
        ...
        features: {
            badge: 'Gate11 Standards',
            title: 'Warum GATE11?',
            subtitle: 'Wir folgen keinen Standards. Wir setzen sie.',
            philosophy: 'UNSERE PHILOSOPHIE LESEN',
            fleet_title: 'Premium Flotte',
            fleet_desc: 'Unsere Fahrschule setzt auf die neuesten Modelle von Volkswagen, BMW und Kawasaki Z650. Erlebe moderne Systeme ab Tag eins.',
            digital_title: 'Mehr Zeit fürs Wesentliche',
            digital_desc: 'Zeit sparen! Einfach lernen! Effizient durch die Ausbildung!',
    ...
    en: {
        ...
        hero: {
            title: 'GATE',
            subtitle: 'Exclusive Vehicles. First-Class Training.',
            description: 'The latest models from Volkswagen, BMW and Kawasaki are available for your training. Experience modern systems from day one.',
        ...
        about: {
            ...
            phil_h2: 'Driving is more than a craft for us – we turn it into true mastery.',
            phil_p1: 'Since 2019, GATE11 has pursued the vision of making driver education an experience of quality and style. Every student is individually supported.',
            phil_p2: 'Our mentors convey a deep understanding of the vehicle, the road, and safe driving.',
            ...
            team_p1: 'Our hand-picked team of experts shares a passion for first-class service.',
            team_p2: 'Trust forms the foundation of every safe drive – and we look forward to accompanying you on your journey.',
        ...
        features: {
            ...
            fleet_desc: 'Our driving school relies on the latest models from Volkswagen, BMW and Kawasaki Z650. Experience modern systems from day one.',
            digital_title: 'More Time for What Matters',
            digital_desc: 'Save time! Learn easily! Efficient throughout your training!',
    ...
    tr: {
        ...
        hero: {
            title: 'GATE',
            subtitle: 'Özel Araçlar. Birinci Sınıf Eğitim.',
            description: 'Eğitiminiz için Volkswagen, BMW ve Kawasaki\'nin en yeni modelleri hizmetinizde. İlk günden itibaren modern sistemleri deneyimleyin.',
        ...
        about: {
            ...
            phil_h2: 'Sürüş bizim için bir zanaatten fazlası – onu gerçek bir ustalığa dönüştürüyoruz.',
            phil_p1: '2019\'dan beri GATE11, sürücü eğitimini kalite ve stil deneyimine dönüştürme vizyonunu takip ediyor. Her öğrenci bireysel olarak desteklenir.',
            phil_p2: 'Mentorlarımız araç, yol ve güvenli sürüş hakkında derin bir anlayış kazandırır.',
            ...
            team_p1: 'Özenle seçilmiş uzman ekibimiz, birinci sınıf hizmet tutkusunu paylaşıyor.',
            team_p2: 'Güven, her güvenli sürüşün temelidir – ve sizi yolculuğunuzda eşlik etmeyi dört gözle bekliyoruz.',
        ...
        features: {
            badge: 'Gate11 Standartları',
            title: 'Neden GATE11?',
            subtitle: 'Standartları takip etmiyoruz. Onları biz belirliyoruz.',
            philosophy: 'FELSEFEMİZİ OKUYUN',
            fleet_title: 'Premium Filo',
            fleet_desc: 'Sürücü okulumuz Volkswagen, BMW ve Kawasaki Z650\'nin en yeni modellerini kullanıyor. İlk günden itibaren modern sistemleri deneyimleyin.',
            digital_title: 'Önemli Olana Daha Fazla Zaman',
            digital_desc: 'Zaman kazan! Kolay öğren! Verimli bir eğitim süreci!',
    ...
    ar: {
        ...
        hero: {
            title: 'GATE',
            subtitle: 'سيارات حصرية. تدريب من الدرجة الأولى.',
            description: 'أحدث موديلات فولكس فاجن وبي إم دبليو وكاواساكي متاحة لتدريبك. اختبر الأنظمة الحديثة من اليوم الأول.',
        ...
        about: {
            ...
            phil_title: 'فلسفتنا',
            phil_h2: 'القيادة بالنسبة لنا أكثر من حرفة – نحولها إلى إتقان حقيقي.',
            phil_p1: 'منذ عام 2019، تتبع GATE11 رؤية جعل تعليم القيادة تجربة من الجودة والأناقة. يتم دعم كل طالب بشكل فردي.',
            phil_p2: 'ينقل مرشدونا فهماً عميقاً للمركبة والطريق والقيادة الآمنة.',
            ...
            team_p1: 'يشارك فريقنا المختار بعناية من الخبراء شغفهم بالخدمة الممتازة.',
            team_p2: 'الثقة هي أساس كل قيادة آمنة – ونحن نتطلع لمرافقتك في رحلتك.',
            team_cta: 'تعرف علينا',
        ...
        features: {
            ...
            fleet_desc: 'تعتمد مدرستنا لتعليم القيادة على أحدث موديلات فولكس فاجن وبي إم دبليو وكاواساكي Z650. اختبر الأنظمة الحديثة من اليوم الأول.',
            digital_title: 'وقت أكثر لما يهم',
            digital_desc: 'وفر الوقت! تعلم بسهولة! تدريب فعال وكفء!',
    ...
    fa: {
        ...
        hero: {
            title: 'GATE',
            subtitle: 'خودروهای انحصاری. آموزش درجه یک.',
            description: 'جدیدترین مدل‌های فولکس‌واگن، بی‌ام‌و و کاوازاکی برای آموزش شما در دسترس است. سیستم‌های مدرن را از روز اول تجربه کنید.',
        ...
        about: {
            ...
            phil_title: 'فلسفه ما',
            phil_h2: 'رانندگی برای ما فراتر از یک حرفه است – ما آن را به استادی واقعی تبدیل می‌کنیم.',
            phil_p1: 'از سال ۲۰۱۹، GATE11 چشم‌انداز تبدیل آموزش رانندگی به تجربه‌ای از کیفیت و سبک را دنبال می‌کند. هر دانش‌آموز به صورت فردی حمایت می‌شود.',
            phil_p2: 'مربیان ما درک عمیقی از خودرو، جاده و رانندگی ایمن منتقل می‌کنند.',
            ...
            team_p1: 'تیم دست‌چین متخصصان ما اشتیاق خود را به خدمات درجه یک به اشتراک می‌گذارد.',
            team_p2: 'اعتماد پایه و اساس هر رانندگی ایمن است – و ما مشتاقانه منتظر همراهی شما در مسیرتان هستیم.',
        ...
        features: {
            ...
            fleet_desc: 'آموزشگاه رانندگی ما بر جدیدترین مدل‌های فولکس‌واگن، بی‌ام‌و و کاوازاکی Z650 تکیه دارد. سیستم‌های مدرن را از روز اول تجربه کنید.',
            digital_title: 'زمان بیشتر برای آنچه مهم است',
            digital_desc: 'صرفه‌جویی در زمان! یادگیری آسان! آموزش کارآمد!',
